...
- No NEW carryover from this sprint. Still open: `AD-ChatV2-Ledger-Tool-RoundTrips` (57.127); `AD-Billing-Outbox-Drain-Test-Flake` (intermittent Risk Class C billing flake); deferred infra (`message_events`/`messages` canonical-ledger consolidation, pg_partman).
