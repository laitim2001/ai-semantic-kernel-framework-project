...
4. **#4 `AD-Context-Layered-Compaction-ACON`** — ← **next per the ranked order**. Layered compaction (tool-result clearing first, ACON 26–54% target band); a different axis from C2 (57.109)'s cheap-tier single-layer compaction.
