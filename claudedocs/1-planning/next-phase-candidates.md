...
- **`AD-ChatV2-Resume-Transcript-Persistence`** (🟢, carried from 57.126) — the resume path doesn't persist main events / messages (pre-existing 57.125 gap); still open.
