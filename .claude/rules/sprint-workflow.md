...
where agent_factor = {
  human (default):      1.0
  agent-delegated:      0.65   (rolled back 2026-05-26 per Sprint 57.46 retro Q4 rollback rule: 1 sprint with ratio > 1.20 — 57.46=~1.60 — single-data-point caution; root cause: activation evidence Sprint 57.40-44 was single-domain `mockup-strict-rebuild` ~5× speedup, Sprint 57.46 multi-track bundle only ~2.1× speedup; was 0.45 tightened 2026-05-26 per Sprint 57.44 retro Q4 — itself tightened from 0.55 activated 2026-05-25 per Sprint 57.42 retro)
}
```
