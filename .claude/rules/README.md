...
### 前端頁面開發 / mockup port / 改設計系統
- 📋 Read: `docs/rules-on-demand/frontend-mockup-fidelity.md`（mockup CSS 逐字複製法 — 權威方法）+ `docs/rules-on-demand/frontend-react.md`（React/TS 通用約定）
