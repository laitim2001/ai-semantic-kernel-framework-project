...
/** Tool call info from pipeline metadata */
...
/** Orchestration metadata attached to pipeline-routed messages */
export interface OrchestrationMetadata {
  ...
  /** Expandable detail text for IntentStatusChip */
  detail?: string;
  /** Tool calls from pipeline execution */
  pipelineToolCalls?: PipelineToolCall[];
  /** Whether this response requires HITL approval */
...
export interface ChatMessage {
  ...
  files?: GeneratedFile[];
  /** Phase 41: Orchestration pipeline metadata for IntentStatusChip display */
