 ...
 *
 * Displays the overall progress bar for the Agent Team,
...
import type { OverallProgressProps, TeamStatus } from './types';
...
/**
 * OverallProgress - Progress bar showing overall team completion
 *
 * @param progress - Progress percentage (0-100)
 * @param status - Current team status (affects color)
