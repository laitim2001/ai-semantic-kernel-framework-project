/**
 * AgentActionList Component
 *
 * Displays a list of Agent actions in a timeline format.
...
/**
 * AgentActionList - Timeline of Agent actions
 *
 * Features:
 ...
 */
export const AgentActionList: FC<AgentActionListProps> = ({
  actions,
  onActionClick,
  maxHeight,
  className,
