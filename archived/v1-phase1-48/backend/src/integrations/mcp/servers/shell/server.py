...
class ShellMCPServer:
    ...
    def __init__(self, config: ShellConfig):
        ...
        self._protocol.set_permission_checker(self._permission_checker, "shell")
    ...
    def _register_all_tools(self) -> None:
        ...
        # Register permission levels from ShellTools (Sprint 113)
        for tool_name, level in ShellTools.PERMISSION_LEVELS.items():
