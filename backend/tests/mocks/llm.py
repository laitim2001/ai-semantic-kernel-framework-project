# =============================================================================
# IPA Platform - Mock LLM Service (Test Utility)
# =============================================================================
# Sprint 112: Migrated from production code (src/integrations/llm/mock.py)
#
# This module was originally located in the production source tree. It has been
# moved to the test mocks directory to eliminate mock classes from production
# code, as flagged in the V7 architecture audit (18 mock classes in prod src).
#
