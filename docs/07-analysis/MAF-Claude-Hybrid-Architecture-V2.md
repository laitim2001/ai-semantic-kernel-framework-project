...
> **重要**: 此圖展示完整的請求處理流程，從用戶輸入到結果返回的每一步驟和決策點。

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│                     IPA Platform 端到端執行流程圖 (Phase 28)                          │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                      │
│  ╔═══════════════════════════════════════════════════════════════════════════════╗  │
│  ║                         入口層 + InputGateway                                 ║  │
...
│  ║                          │   │                                              │  ║  │
│  ║                          │   │  ┌────────────────────────────────────────┐  │  ║  │
│  ║                          │   │  │ Teams Adaptive Card 發送給審批人:      │  │  ║  │
│  ║                          │   │  │ 「ETL Pipeline 修復需要您的審批」      │  │  ║  │
│  ║                          │   │  │ [批准] [拒絕] [需要更多信息]           │  │  ║  │
│  ║                          │   │  └────────────────────────────────────────┘  │  ║  │
│  ║                          │   │                                              │  ║  │
│  ║                          │   │  等待審批... (timeout: 30 min)               │  ║  │
...
│  ║   │ Metrics          │  │ Traces      │  │ Analytics   │  │ Dashboard   │     ║  │
│  ║   │ • 路由命中率     │  │             │  │             │  │             │     ║  │
│  ║   │ • 延遲分布       │  │             │  │             │  │             │     ║  │
│  ║   │ • 審批通過率     │  │             │  │             │  │             │     ║  │
│  ║   └──────────────────┘  └─────────────┘  └─────────────┘  └─────────────┘     ║  │
...
6. HybridOrchestratorV2 (選擇 MAF 或 Claude 框架)
7. Worker Pool (Claude SDK 自主執行)
8. MCP Gateway (統一工具存取)
9. AG-UI SSE (即時串流結果到前端)
```
