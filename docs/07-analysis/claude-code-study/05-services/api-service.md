...
> API client layer — provider selection, streaming, retry strategy, error classification, prompt caching, and supporting API clients.

**Source**: `src/services/api/` (21 files, ~360KB)
**Quality**: 9.5/10 — full file inventory, all functions cataloged, exact constants verified
