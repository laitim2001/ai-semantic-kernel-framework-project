...
graph TB
    ...
    subgraph "Layer 2: API Gateway"
        API["FastAPI<br/>152 files | 47,376 LOC<br/>591 endpoints"]
    end
...
│                1,028 files (792 .py + 236 .ts/.tsx) | 327,582 LOC                   │
...
│  ╔══════════════════════════════│════════════════════════════════════════════════╗    │
│  ║  Layer 2: API Gateway (591 endpoints, 44 route modules)                      ║    │
...
│                    792 .py + 236 .ts/.tsx = 1,028 files, 327,582 LOC                │
...
│                                                                                     │
│  ╔══════════════════════════════════════════════════════════════════════════════╗    │
│  ║  Layer 2: API Gateway (591 endpoints, 44 route modules, 56 routers)         ║    │
│  ║  152 files | 47,376 LOC | FastAPI (port 8000)                               ║    │
...
│  ║   │  ServiceNow/     │  │ Router (3-tier)  │  │ Engine (3,407 LOC) │        ║    │
...
## 2. Backend Breakdown (792 Python files, 273,344 LOC)
...
| **Subtotal (layers)** | | **790** | **273,306** | **99.99%** |
| Root __init__.py* | src/, integrations/ | 2 | 38 | 0.01% |
| **Total** | | **792** | **273,344** | **100%** |
