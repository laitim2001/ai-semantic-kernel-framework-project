...
- `ag_ui/routes.py` — 30 endpoints (run + threads + HITL + tool-ui + shared-state + predictive)
...
Phase 38:    591 endpoints  (final count including n8n/orchestrator/tasks/knowledge/graph/chat_history)
```
