...
Phase 28 將擴展以下功能，主要影響 **Layer 3 (MAF 編排層)** 和 **Layer 1 (入口層)**：

| 功能 | 描述 | 架構層級 | 狀態 |
|------|------|---------|------|
| **三層意圖路由** | Pattern → Semantic → LLM 分層路由 | Layer 3 | 📋 計劃中 |
| **Input Gateway** | 多來源輸入標準化 (ServiceNow, Prometheus, 用戶) | Layer 1 | 📋 計劃中 |
| **Guided Dialog** | 完整度檢查 + 引導式對話 | Layer 3 | 📋 計劃中 |
| **增量更新機制** | 對話後不重新分類，只更新欄位 | Layer 3 | 📋 計劃中 |
| **IT Intent 風險映射** | Intent → Risk Level 自動映射 | Layer 3 | 📋 計劃中 |
...
| Sprint | 完成功能 | 更新狀態 |
|--------|---------|---------|
| Sprint 91-93 | 三層意圖路由核心 | 待更新 |
| Sprint 94-95 | GuidedDialogEngine + InputGateway | 待更新 |
| Sprint 96-97 | RiskAssessor + HITLController | 待更新 |
| Sprint 98-99 | 整合 + E2E 測試 | 待更新 |
