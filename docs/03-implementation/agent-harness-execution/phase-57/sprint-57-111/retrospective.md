...
- **AD-Lint-MHist-Verbosity recurred** — 2 MHist lines added AFTER the Day-1 flake8 run slipped E501 into the Day-1 commit; the Day-3 sweep caught them. Lesson: re-run flake8 AFTER adding MHist (header edits happen post-test-run). Already a known trap; reinforced.
