...
- [x] **Commit `a27f0ab3`** → PR #364 pushed + opened → CI all-green (5 required) → squash-merged (gh-verified MERGED, main `e1083964`, mergedAt 2026-07-01T09:40:57Z) → status flip done (chore branch)
